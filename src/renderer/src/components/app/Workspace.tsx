...
import { AutoBillsList } from "../bills/AutoBillsList";
import { MenuBar } from "../common/MenuBar";
import { AutoBillForm } from "../bills/AutoBillForm";
import { ManualBillForm } from "../bills/ManualBillForm";
import BillDetail from "../bills/BillDetail";
import Contacts from "../contacts/Contacts";
import ContactForm from "../contacts/ContactForm";
import ContactDetail from "../contacts/ContactDetail";
import { MonthlySummary } from "../bills/MonthlySummary";
...
import { MealPlanning } from "../meals/MealPlanning";
import { IngredientDetail } from "../meals/IngredientDetail";
          ...
          tabs.map((tab) => (
            ...
            >
              ...
              {tab.type === "tag-manager" && (
                <TagManager profileId={profileId} />
              )}
            </div>
          ))
        )}
