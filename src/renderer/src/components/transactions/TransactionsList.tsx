...
export function TransactionsList({
  ...
  const [modalTxnId, setModalTxnId] = useState<number | null>(null);
  ...
  return (
    ...
    >
      ...
      <TransactionDetailModal
        isOpen={modalTxnId !== null}
        transactionId={modalTxnId!}
        profileId={profileId}
        onClose={() => setModalTxnId(null)}
        onOpenInTab={(id) => {
          setModalTxnId(null);
